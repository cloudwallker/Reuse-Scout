...
核对日期：2026-09-13。首批适配 Codex、Claude Code 的本地直接目录安装，共用 `skills/reuse-scout/`。真实宿主验收尚未完成，不标注“所有 Agent 兼容”。
...
依据：[OpenAI Skills](https://learn.chatgpt.com/docs/build-skills)、[Claude Code Skills](https://code.claude.com/docs/en/skills)、[Agent Skills 格式](https://agentskills.io/specification)。CLI 版本与实际结果见 [测试报告](TEST_REPORT.md)。
